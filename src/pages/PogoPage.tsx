...
export default function PogoPage() {
  ...
  return (
    <div className="bg-[#000000] text-white min-h-screen selection:bg-purple-500/30 selection:text-white">
      <TopBar />
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="flex flex-col items-center text-center mt-12 mb-32 md:mb-48">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-3 px-8 py-4 bg-white/5 border border-white/10 rounded-full text-white font-medium shadow-[0_0_40px_rgba(168,85,247,0.15)]"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
             ...
             <motion.div 
               whileHover={{ y: -5 }}
               className="md:col-span-2 group relative rounded-[2.5rem] border border-white/10 bg-[#0a0b0d] overflow-hidden min-h-[500px] md:min-h-[600px] flex flex-col md:flex-row items-center"
             >
             ...
             <motion.div 
               whileHover={{ y: -5 }}
               className="group relative rounded-[2.5rem] border border-white/10 bg-[#0a0b0d] overflow-hidden min-h-[500px] flex flex-col"
             >
          ...
          <div className="mt-24 mb-10 p-12 md:p-20 rounded-[2.5rem] border border-white/10 bg-white/[0.02] text-center relative overflow-hidden backdrop-blur-xl">
             ...
             <Mountain className="w-12 h-12 text-slate-300 mx-auto mb-8 opacity-60" />
