  ...
  return (
    <div className="bg-bg-primary text-text-primary selection:bg-card-border min-h-screen flex flex-col">
      ...
      <main className="flex-1 pt-32 pb-24 px-8 max-w-4xl mx-auto w-full">
        <h1 className="text-5xl md:text-[5.5rem] font-medium tracking-tight mb-16 leading-[0.9] text-text-primary">Terms of <span className="text-text-secondary">Service.</span></h1>
        ...
        <div className="space-y-8 text-text-secondary font-light">
          ...
          <section>
            <h2 className="text-xl font-medium text-text-primary mb-6">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-text-primary mb-6">2. Nature of the Website</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-text-primary mb-6">3. Permitted Use</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-text-primary mb-6">4. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-text-primary mb-6">5. No Professional or Operational Reliance</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-text-primary mb-6">6. Disclaimer of Warranties</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-text-primary mb-6">7. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-text-primary mb-6">8. Third-Party Links</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-text-primary mb-6">9. Future Products and Services</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-text-primary mb-6">10. Website Changes</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-text-primary mb-6">11. Age Requirement</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-text-primary mb-6">12. Governing Law</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-text-primary mb-6">13. Contact</h2>
