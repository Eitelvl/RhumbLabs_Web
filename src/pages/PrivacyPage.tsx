...
export default function PrivacyPage() {
  return (
    <div className="bg-black text-white selection:bg-white/20 min-h-screen flex flex-col">
      <TopBar />
      <main className="flex-1 pt-32 pb-24 px-8 max-w-4xl mx-auto w-full">
        <h1 className="text-5xl md:text-[5.5rem] font-medium tracking-tight mb-16 leading-[0.9] text-white">Privacy <span className="text-[#a1a1aa]">Policy.</span></h1>
        
        <div className="space-y-8 text-[#a1a1aa] font-light">
          <div>
            <p className="text-[10px] font-bold uppercase tracking-widest text-[#a1a1aa] mb-12">Last updated: April 2026</p>
          </div>

          <section>
            <h2 className="text-xl font-medium text-white mb-6">1. Introduction</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-white mb-6">2. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-white mb-6">3. How We Use Information</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-white mb-6">4. Contact Form Communications</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-white mb-6">5. Legal Basis and User Choice</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-white mb-6">6. Data Retention</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-white mb-6">7. Cookies and Similar Technologies</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-white mb-6">8. Third-Party Services</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-white mb-6">9. Data Security</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-white mb-6">10. International Processing</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-white mb-6">11. Your Rights</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-white mb-6">12. Children</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-white mb-6">13. Changes to This Privacy Policy</h2>
          ...
          <section>
            <h2 className="text-xl font-medium text-white mb-6">14. Contact</h2>
