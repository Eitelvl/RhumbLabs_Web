  ...
  return (
    <div className="bg-surface text-on-surface selection:bg-primary/30 min-h-screen flex flex-col">
      ...
      <main className="flex-1 pt-32 pb-24 px-8 max-w-4xl mx-auto w-full">
        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tighter text-on-surface mb-12">Privacy <span className="text-primary">Policy.</span></h1>
        ...
        <div className="space-y-8 text-on-surface-variant font-manrope">
          ...
          <section>
            <h2 className="text-xl font-bold text-on-surface mb-4">3. How We Use Information</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-on-surface mb-4">4. Contact Form Communications</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-on-surface mb-4">5. Legal Basis and User Choice</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-on-surface mb-4">6. Data Retention</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-on-surface mb-4">7. Cookies and Similar Technologies</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-on-surface mb-4">8. Third-Party Services</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-on-surface mb-4">9. Data Security</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-on-surface mb-4">10. International Processing</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-on-surface mb-4">11. Your Rights</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-on-surface mb-4">12. Children</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-on-surface mb-4">13. Changes to This Privacy Policy</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-on-surface mb-4">14. Contact</h2>
